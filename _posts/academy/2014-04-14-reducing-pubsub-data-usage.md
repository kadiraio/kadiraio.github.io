...
These are only some of the tips you can use to save subscription data, save server memory usage, and reduce latency. Try applying some of these; you can verify the results from the [Network Impact](http://support.meteorapm.com/knowledgebase/articles/347428-network-impact) metric in the Kadira.